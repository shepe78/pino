...
<div class="container">
	<div class="card border-primary">
		<div class="card-header"><h3 style="color: blue" class="card-title">Edición del empleado</h3></div>
		<div class="card-body text-dark">
            ...
            <div class="form-group col-sm-6">
              ...
              {!! Form::select('cliente_id', $clientes, $empleado->cliente_id, ['class' => 'form-control']) 
              !!}
              </div>
              </div>
              <br>
              ...
              {!! Form::select('status', 
              ['Activo'=>'Activo',
              'Inactivo'=>'Inactivo'],$empleado->status , 
              ['class' => 'form-control']) 
              !!}
              </div>
              </div>
