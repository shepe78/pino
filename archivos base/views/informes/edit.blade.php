...
<div class="container">
	<div class="card border-primary">
		...
		<div class="card-body text-dark">
			{!!Form::open(['route'=> ['informes.update',$informe],'enctype'=>'multipart/form-data', 'method'=>'PUT'])!!}
            {{Form::token()}}
            ...
            <div class="row">
              ...
              <div class="row">
                <!-- status Field -->
                     ...
                     {!! Form::select('status',['Elaborado'=>'Elaborado','En Proceso'=>'En Proceso','No Aplica'=>'No Aplica','Concluido'=>'Concluido','Negativa'=>'Negativa'],$informe->status , ['class' => 'form-control']) !!}
                     </div>
              </div>
