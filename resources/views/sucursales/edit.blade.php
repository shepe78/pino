    ...
    {!!Form::open(['route'=> ['sucursales.update',$sucursal], 'method'=>'PUT'])!!}
            ...
            <div class="row">{{--  fila # 1 --}}
              <div class="form-group col-md-6">
                <label style="color: #1380B9" for="descripcion">Nombre de la sucursal:</label>
                <input type="text" name="descripcion" class="form-control" value="{{$sucursal->descripcion}}" required="true">
              </div>
            </div>   
  </div>
  <!-- /.box-body -->
